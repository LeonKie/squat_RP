import * as tf from '@tensorflow-models/posenet/dist/node_modules/@tensorflow/tfjs-core';
import { InputResolution, Keypoint, Padding, Pose, PosenetInput, PoseNetOutputStride, TensorBuffer3D, Vector2D } from '@tensorflow-models/posenet/dist/types';
